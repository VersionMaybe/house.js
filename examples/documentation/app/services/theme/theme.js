...
this.appStyles = document.createElement('style');
...
this.setTheme = (theme) => {
    ...
    const stylesheet = this.appStyles.sheet;
    ...
    metaElement.content = theme.titlebar;
...
this.loadInitialThemes = async () => {
    for(let theme of this.themes) {
        const e = await app.grab(theme, null, 'json');
        if (e.error) {
